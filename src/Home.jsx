...
const Home = () => {
    ...
    const checkoutHandler = async (amount) => {
        ...
        const { data: { key } } = await axios.get("https://razorpay-backend-integration.onrender.com/api/getkey")

        const { data: { order } } = await axios.post("https://razorpay-backend-integration.onrender.com/api/checkout", {
            amount
        })
